...
const handleSearch = useDebouncedCallback((search: string) => {
  ...
  return (
    ...
    <div className='admin-navbar'>
     ...
     <input type="text" className="grow" placeholder="name, location or state" defaultValue={searchParams.get('search')?.toString()} onChange={(e) => {handleSearch(e.target.value)}} />
     </label>
